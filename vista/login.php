...
<body class="login">
    ...
    <nav class="py-3 navbar navbar-expand-lg fixed-top auto-hiding-navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="./login.php">VideoClub</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="./admin/index.php">Administrar películas</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 mt-5">
                ...
                <div class="text-center mb-1 text-dark">email: user@gmail.com - password: 1234</div>
                <div class="card my-3">
